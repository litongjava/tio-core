...
public class SSLFacade implements ISSLFacade {
  ...
  public boolean isCloseCompleted() {
    /*
     * Host application should only close underlying transport after close_notify packet generated by wrap has been sent to peer. Use this method to check if the packet has been generated
     */
